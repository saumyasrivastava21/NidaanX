    ...
    <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              AI-powered X-ray diagnosis platform using YOLO-based models for multiclass disease detection.
              Providing accurate and fast medical diagnosis assistance.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700 text-center text-gray-600 dark:text-gray-400">
          <p>&copy; {new Date().getFullYear()} NidaanX. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
