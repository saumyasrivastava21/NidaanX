          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-medical-100 dark:bg-medical-900 rounded-lg flex items-center justify-center flex-shrink-0">
                    <svg className="w-6 h-6 text-medical-600 dark:text-medical-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
